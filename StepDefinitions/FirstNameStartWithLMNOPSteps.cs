...
namespace DigitalAutomationQuoteTest.StepDefinitions
{
    ...
    public sealed class FirstNameStartWithLMNOPSteps
    {
        ...
        public void WhenIOnButtonOption(string fname)
        {
            ...
            {
                Wait.Until(TimeSpan.FromSeconds(10), () => this.AutomationTechTestLandingPage.SignButton.Displayed);
        ...
        {
            Wait.Until(TimeSpan.FromSeconds(15), () => this.AutomationTechTestLandingPage.OptionsLabel.Displayed);
