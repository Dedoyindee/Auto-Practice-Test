...
namespace DigitalAutomationQuoteTest.StepDefinitions
{
    ...
    public sealed class FirstNameStartsWithVWXYZSteps
    {
        ...
        public void WhenIClickOnGettingStartedButtonOption(string fname)
        {
            ...
            {
                Wait.Until(TimeSpan.FromSeconds(10), () => this.AutomationTechTestLandingPage.GettingStartedButton.Displayed);
        ...
        {
            Wait.Until(TimeSpan.FromSeconds(10), () => this.AutomationTechTestLandingPage.BackGettingStartedButton.Displayed);
