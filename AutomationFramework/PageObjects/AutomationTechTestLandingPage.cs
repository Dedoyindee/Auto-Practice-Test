...
using DigitalAutomationQuoteTest.Helpers;
  ...
  public class AutomationTechTestLandingPage : BasePage
    {
        ...
        public bool IsNugetPackageDisplayed
        {
            get
            {
                Wait.Until(TimeSpan.FromSeconds(10), () => this.NPackageNameText.Displayed);
        ...
        {
            Wait.Until(TimeSpan.FromSeconds(10), () => this.RunButton.Displayed);
        ...
        {
            Wait.Until(TimeSpan.FromSeconds(10), () => this.SaveButton.Displayed);
            this.RunButton.Click();
        ...
        public string TextMessage
        {
            get
            {
                   ...
                   Wait.Until(TimeSpan.FromSeconds(10), () => this.HelloWorldText.Displayed);
        ...
        {
            Wait.Until(TimeSpan.FromSeconds(10), () => this.FirstNameText.Displayed);
        ...
        public AutomationTechTestLandingPage WithNPackagename(string nugname)
        {
            ...
            Wait.Until(TimeSpan.FromSeconds(10), () => this.NugetPackagesText.Displayed);
            this.NugetPackagesText.EnterText(nugname);



              Wait.Until(TimeSpan.FromSeconds(10), () => this.NunitPackageSelectedText.Displayed);
            this.NunitPackageSelectedText.Hover(this.Driver);
            this.NunitPackageSelectedText.Click();


            Wait.Until(TimeSpan.FromSeconds(10), () => this.NPackageNumberSelected.Displayed);
        ...
        //public string ConfirmLinkAppPresent(string linkName)
        //{
        //    foreach (var lnksApp in this.AppLink)
        //    {
        //        if (lnksApp.Text.Equals(linkName))
        //        {
        //            return lnksApp.Text;
        //        }
